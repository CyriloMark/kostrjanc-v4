...
export default function UserProfileEdit({ navigation, route }) {
  ...
  const checkButton = () => {
    ...
    if (updatedUserData.description != userData.description) inputValid = true;
    ...
    <View style={[style.container, style.bgBlack]}>
      ...
      >
        ...
        <Pressable style={{ zIndex: 10 }}>
          <BackHeader
            title={`${getLangs("editprofile_headeredit")} ${userData.name}`}
        ...
        >
          ...
          <View style={styles.sectionContainer}>
            ...
            <Text style={[style.tBlue, style.Ttitle2]}>{userData.name}</Text>
            <Text
              style={[
                style.tWhite,
                style.TsmRg,
