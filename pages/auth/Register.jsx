...
export default function Register({ navigation }) {
  ...
  let checkButton = () => {
    ...
    switch (currentRegisterState) {
      case 0:
        if (registerData.name.length > 2 && registerData.name.length <= 32)
          inputValid = true;
        break;
      case 1:
            ...
            Storage.getDownloadURL(pbImgRef)
              .then((url) => {
                set(ref(db, `users/${userCredential.user.uid}`), {
                  ...
                  pbUri: url,
                  follower: ["Co2jZnyLZaf04HihTPtrzDNzaBG2"],
                  following: [],
                  posts: [],
                  events: [],
                  isMod: false,
  ...
  return (
    <View style={[style.container, style.bgBlack]}>
      ...
      >
        <BackHeader onBack={() => navigation.goBack()} showReload={false} />
        ...
        >
          <View style={styles.titleContainer}>
            ...
            <Text
              style={[style.tWhite, style.Tmd, { marginTop: style.defaultMmd }]}
            >
              {getLangs("auth_register_0_intro")}
            </Text>
          </View>

          <View style={[style.line, { marginTop: style.defaultMlg }]} />
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={[style.pH, { marginTop: style.defaultMmd }]}>
              <InputField
                ...
                placeholder={getLangs("input_placeholder_username")}
                maxLength={32}
          ...
          {currentRegisterState >= 1 ? (
            <View style={styles.sectionContainer}>
              <Text style={[style.Ttitle2, style.tWhite]}>
                ...
                <Text style={style.tBlue}>{registerData.name}</Text>!
              </Text>
              <Text
                style={[
                  style.Tmd,
              ...
              <Pressable
                onPress={() => {
                  if (currentRegisterState === 1) openImagePickerAsync();
                }}
                style={[
                  ...
                  {pbImageUri !== null ? (
                    ...
                    >
                      ...
                      <Text style={[style.Tmd, style.tBlue, styles.hintText]}>
                        {getLangs("auth_register_1_pbhint")}
                      </Text>
                    </View>
                  )}
                </View>
              ...
              <View style={[style.pH, { marginTop: style.defaultMmd }]}>
                ...
                <View>
                  ...
                  <InputField
                    ...
                    placeholder={getLangs("input_placeholder_email")}
                    maxLength={128}
                    keyboardType="email-address"
                    autoComplete="email"
                    autoCapitalize="none"
                    textContentType="emailAddress"
                    icon={<SVG_Email fill={style.colors.blue} />}
                    onChangeText={(val) => {
                      setRegisterData({
                        ...registerData,
                        email: val,
                ...
                <View style={{ marginTop: style.defaultMmd }}>
                  ...
                  <InputField
                    editable={currentRegisterState === 3}
                    placeholder={getLangs("input_placeholder_password")}
                    maxLength={128}
                    keyboardType="default"
                ...
                <View style={{ marginTop: style.defaultMmd }}>
                  ...
                  >
                    {getLangs("input_entertitle_passwordconfirm")}
                  </Text>
                  <InputField
                    editable={currentRegisterState === 3}
                    placeholder={getLangs("input_placeholder_password")}
          ...
          {currentRegisterState >= 4 ? (
            <View style={styles.sectionContainer}>
              ...
              <View style={[style.pH, { marginTop: style.defaultMmd }]}>
                <Text style={[style.tWhite, style.TsmRg, { opacity: 0.5 }]}>
                  Eiusmod labore laborum fugiat esse proident eu aute anim
                  eiusmod anim minim nulla. Reprehenderit reprehenderit sint
                  veniam irure ea culpa minim mollit reprehenderit aute.
                  Pariatur non eiusmod exercitation dolore anim proident nostrud
                  aliqua. Laboris nisi voluptate id labore anim exercitation
                  laboris laboris nulla. Labore velit magna voluptate do ut
                  cillum consequat consectetur duis. Eiusmod labore laborum
                  fugiat esse proident eu aute anim eiusmod anim minim nulla.
                  Reprehenderit reprehenderit sint veniam irure ea culpa minim
                  mollit reprehenderit aute. Pariatur non eiusmod exercitation
                  dolore anim proident nostrud aliqua. Laboris nisi voluptate id
                  labore anim exercitation laboris laboris nulla. Labore velit
                  magna voluptate do ut cillum consequat consectetur duis.
                  Eiusmod labore laborum fugiat esse proident eu aute anim
                  eiusmod anim minim nulla. Reprehenderit reprehenderit sint
                  veniam irure ea culpa minim mollit reprehenderit aute.
                  Pariatur non eiusmod exercitation dolore anim proident nostrud
                ...
                {registerData.agbChecked ? (
                  <View style={styles.sectionContainer}>
                    <Text style={[style.TlgRg, style.tWhite]}>
                      {getLangs("auth_register_4_checksettingstext")}
                      {"\n"}
                      {getLangs("auth_register_4_publishtext")}
                    </Text>
                  </View>
                ) : null}
              </View>
          ...
          <View style={[style.allCenter, styles.button]}>
            <EnterButton
              onPress={() => {
                if (buttonChecked) {
                  if (currentRegisterState === 4 && !registering) {
                    register();
