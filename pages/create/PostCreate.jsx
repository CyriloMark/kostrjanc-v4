...
export default function PostCreate({ navigation, route }) {
  ...
  const setUnfullfilledAlert = () => {
    let missing = "";
    if (post.title.length === 0) missing += `\n${getLangs("missing_title")}`;
  ...
  const publishPost = async () => {
    ...
    if (
      !fromLinking &&
      !(!checkForLinkings(post.title) && !checkForLinkings(post.description))
    ) {
      ...
      >
        ...
        >
            ...
            >
              ...
              >
                {imageUri !== null ? (
                  ...
                  <View
                    style={[styles.image, style.allCenter, styles.imageBorder]}
                  >
                    <SVG_Post
          ...
          <View style={[style.allCenter, styles.button]}>
            <EnterButton onPress={publishPost} checked={buttonChecked} />
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
